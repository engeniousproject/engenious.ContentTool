...
{
    public abstract partial class EffectModelViewer : UserControl, IViewer
    {
        ...
        protected EffectModelViewer(bool isEffectView)
        {
            _isEffectView = isEffectView;
            InitializeComponent();
            _game = new EffectModelViewerGame(gameControl, isEffectView);
        ...
        private List<IEffectParameterBinding> _bindings = new List<IEffectParameterBinding>();
        ...
        public Control GetViewerControl(engenious.ContentTool.Models.ContentFile file)
        {
            History = new History();
            ContentFile = file;
            try
